...
async function lookup() {
    ...
    const params = { hostname: hostname.value.trim(), rrtype: 'AAAA' }
...
function getRowClass(item) {
    return { class: typeof item.item.content === 'string' && item.item.content.startsWith('queryAaaa E') ? 'unavailable-row' : 'available-row' }
}
