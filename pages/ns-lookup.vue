...
async function lookup() {
    ...
    const params = { hostname: hostname.value.trim(), rrtype: 'NS' }
...
<template>
    <v-container>
        <div class="d-flex align-center">
            <v-text-field label="Domain" placeholder="ns.example.com" v-model="hostname" class="flex-grow-0 mr-2"
