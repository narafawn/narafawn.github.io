...
const text = ref('')
const hash = ref('c672b8d1ef56ed28ab87c3622c5114069bdd3ad7b8f9737498d0c01ecef0967a')

function doHash(string) {
    hash.value = forge.md.sha512.sha256.create().update(string).digest().toHex()
}
...
<template>
    <v-container>
        ...
        <v-text-field label="SHA512/256" v-model="hash"></v-text-field>
    </v-container>
</template>
