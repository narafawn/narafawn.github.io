...
async function lookup() {
    ...
    const params = { hostname: hostname.value.trim(), rrtype: 'MX' }
...
function getRowClass(item) {
    return { class: typeof item.item.content === 'string' && item.item.content.startsWith('queryMx E') ? 'unavailable-row' : 'available-row' }
}
